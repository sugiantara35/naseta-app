...
export default function TambahHargaSewaPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    const { error } = await supabase.from('harga_sewa').insert({
  ...
  return (
    <div style={{ maxWidth: '560px' }}>
      <div style={{ marginBottom: '28px' }}>
        ...
        <h1 style={{ fontSize: '22px', fontWeight: '600', color: NAVY, margin: '0 0 6px 0' }}>Tambah Harga Sewa</h1>
        <p style={{ fontSize: '13px', color: SECONDARY, margin: 0 }}>Tambah item harga sewa baru</p>
      </div>
